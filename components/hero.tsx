            ...
            <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-24">
                <div className="relative z-10">
                    ...
                    <p className="mt-6 max-w-md text-pretty text-lg leading-relaxed text-md-cream/80">
                        Restaurants can already send customers home with beer and wine. We're working to give them one 
                        more option: sealed cocktails to go, with clear rules for responsible service across Anne Arundel 
