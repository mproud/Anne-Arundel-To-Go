            ...
            <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-24">
                <div className="relative z-10">
                    ...
                    <p className="mt-6 max-w-md text-pretty text-lg leading-relaxed text-md-cream/80">
                        To-go cocktails gave our neighborhood restaurants more flexibility when they needed 
                        it most. The temporary policy ended, but the idea still makes sense. Join thousands of 
                        neighbors asking to bring cocktails to go back to Anne Arundel County and Annapolis.
                    </p>
