/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./worker-configuration.d.ts` (hash: 8f6716a10052767a5012bf950fec2483)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 
interface __BaseEnv_CloudflareEnv {
	anne_arundel_to_go_forms: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	RESEND_FROM_EMAIL: "Anne Arundel To Go <hello@annearundeltogo.com>";
	RESEND_PETITION_SEGMENT_ID: "7fb44c72-7761-46c3-87d0-109b40aa00b6";
	RESEND_UPDATES_SEGMENT_ID: "80ec53ce-33ed-46b4-835b-b02b1a533bf7";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_FROM_EMAIL" | "RESEND_PETITION_SEGMENT_ID" | "RESEND_UPDATES_SEGMENT_ID" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET" | "FORM_RATE_LIMIT_SECRET" | "RESEND_API_KEY">> {}
}
